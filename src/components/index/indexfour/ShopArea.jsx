      ...
      <div className="row justify-content-center">
        <div className="col-xl-6 col-lg-8">
          <div className="section-title home-four-title text-center mb-35">
            <h2>produits <span>gaming</span></h2>
            <p>Retrouver et Commander les derniers produits et accessoires gaming en vente de la B-Gaming Corp.</p>
          </div>
        </div>
      </div>
        ...
        <div className="col-xl">
          <div className="shop-item">
            ...
            <div className="product-content">
              ...
              <h4><a href="/#">Casque de Réalité Virtuel</a></h4>
              <div className="product-meta">
                <div className="product-price">
                  <h5>75.000 Fcfa</h5>
                </div>
